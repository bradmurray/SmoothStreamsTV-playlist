...
__appname__ = 'SmoothStreamsTV-VLC-generator'
...
instructions = '''
WELCOME to the SmoothStreamsTV-VLC-generator.

This program will generate an .m3u8 playlist file for SmoothStreamsTV IPTV provider, playable in VLC.
...
def main():
    print(instructions)
    # prompt user to input their URL and extract the token
    URL = raw_input('\n')
...
def extractToken(URL):
    '''extract the token from the provided URL'''
    try:
